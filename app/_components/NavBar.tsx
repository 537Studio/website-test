...
export default function NavBar() {
  ...
  return (
    <div className="fixed top-0 flex h-12 w-full items-center justify-between border-b-2 border-solid border-slate-100 bg-white dark:bg-black z-50 px-3  dark:border-slate-900">
